...
import 'package:edo_jobs_portal/pages/form_cards_page/try.dart';
...
class ITGrantApplicationForm extends StatefulWidget {
  static const String route = 'ITGrantApplicationForm';
  const ITGrantApplicationForm({Key? key}) : super(key: key);

  @override
  State<ITGrantApplicationForm> createState() => _ITGrantApplicationFormState();
}

class _ITGrantApplicationFormState extends State<ITGrantApplicationForm> {
  ...
  TextEditingController phoneOfHeadOfBusiness = TextEditingController();
  TextEditingController firstNameOfHeadOfBusiness = TextEditingController();
  TextEditingController lastNameOfHeadOfBusiness = TextEditingController();
  TextEditingController emailOfHeadOfBusiness = TextEditingController();
                ...
                Center(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Edo State NG-CARES - DLI 3.3: IT Enhancement Grant Application',
