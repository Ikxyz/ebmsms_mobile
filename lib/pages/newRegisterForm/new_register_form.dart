...
class NewRegisterForm extends StatefulWidget {
  static const String route = "newform";
  const NewRegisterForm({Key? key}) : super(key: key);

  @override
  _NewRegisterFormState createState() => _NewRegisterFormState();
}
              ...
              Theme(
                ...
                child: Container(
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      Container(
                          height: 300, child: const RegisterExpandedForm())
                    ],
                  ),
                ),
              ),
              ...
              Theme(
                ...
                child: Container(
                  ...
                  child: ExpansionTile(
                    ...
                    children: [
                      Container(
                          height: 300, child: const NewContactExpandedForm())
                    ],
                  ),
                ),
              ),
