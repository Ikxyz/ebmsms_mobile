...
import '../dashbaord/admin_dashboard.dart';
import '../management/management.dart';

class DelincedGrants extends StatefulWidget {
  static const String route = "DelincedGrants";
  const DelincedGrants({Key? key}) : super(key: key);

  @override
  _DelincedGrantsState createState() => _DelincedGrantsState();
}

class _DelincedGrantsState extends State<DelincedGrants> {
  List cardList = [
    Charty(),
    Item2(),
  ];
